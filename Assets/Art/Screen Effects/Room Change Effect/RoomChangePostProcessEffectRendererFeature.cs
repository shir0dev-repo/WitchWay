...
public sealed class RoomChangePostProcessEffectRendererFeature : ScriptableRendererFeature
{
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        RoomChangePostProcessEffectVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<RoomChangePostProcessEffectVolumeComponent>();
    ...
    private class CustomPostRenderPass : ScriptableRenderPass
    {
        ...
        private static void ExecuteMainPass(RasterCommandBuffer cmd, RTHandle sourceTexture, Material material)
        {
            ...
            RoomChangePostProcessEffectVolumeComponent myVolume = VolumeManager.instance.stack?.GetComponent<RoomChangePostProcessEffectVolumeComponent>();
            if (myVolume != null)
                s_SharedPropertyBlock.SetFloat("_Pixel_Size", myVolume.intensity.value * 256);
